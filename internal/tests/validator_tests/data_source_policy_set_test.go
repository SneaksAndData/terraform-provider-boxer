...
func TestDataSourceCedarPolicySet_reading(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tests.RenderTemplate(testContext, "data_source_policy_set.tmpl.tf"),
				ConfigStateChecks: []statecheck.StateCheck{
					...
					assertions.ValidatePolicySetCedarIsParseable("data.boxer_policy_set.example"),
					assertions.ValidatePolicySetJsonIsParseable("data.boxer_policy_set.example"),
				},
			},
		},
	})
