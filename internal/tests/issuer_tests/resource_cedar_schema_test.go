...
import (
	...
	"terraform-provider-boxer/internal/tests/validation"
	"testing"
)

func TestCedarSchema_creation(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: tests.RenderTemplate(tests.NewTestContext(randomName, services, token), "cedar_schema.tmpl"),
				ConfigStateChecks: []statecheck.StateCheck{
					...
					validation.ValidateSchemaIsParseable("boxer_issuer_cedar_schema.example"),
				},
			},
		},
	})
